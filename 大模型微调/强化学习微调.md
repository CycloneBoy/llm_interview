...
![1758079724297](image/强化学习微调/1758079724297.png)



# 7. DAPO (Decoupled Clip and Dynamic sAmpling Policy Optimization)
> paper link: [DAPO: An Open-Source LLM Reinforcement Learning System at Scale](https://arxiv.org/abs/2503.14476v2)

![1758091999893](image/强化学习微调/1758091999893.png)
...
![1758092038325](image/强化学习微调/1758092038325.png)



# 8. GSPO (Group Sequence Policy Optimization)
> paper link: [Group Sequence Policy Optimization](https://arxiv.org/abs/2507.18071)

## ppo loss
![1758082936780](image/强化学习微调/1758082936780.png)
![1758082956650](image/强化学习微调/1758082956650.png)

## grpo loss
![1758082979316](image/强化学习微调/1758082979316.png)

## gspo loss
![1758083729863](image/强化学习微调/1758083729863.png)
...
![1758085422834](image/强化学习微调/1758085422834.png)

3. 算法

![1758085475140](image/强化学习微调/1758085475140.png)

# 9. DCPO (DCPO: Dynamic Clipping Policy Optimization)
> paper link: [DCPO: Dynamic Clipping Policy Optimization](https://arxiv.org/abs/2509.02333v2)

DCPO提出的改进主要是三个方面：动态裁剪、优势累积平滑和取消批次间的损失平均。
...
[GRPO及其后续改进](https://yibotongxue.github.io/blog/blog/agentic-rl/grpo.html)
